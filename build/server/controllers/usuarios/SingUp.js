...
exports.SigUp = exports.singUpValidation = void 0;
const yup = __importStar(require("yup"));
const middlewares_1 = require("../../shared/middlewares");
const http_status_codes_1 = require("http-status-codes");
const usuarios_1 = require("../../database/providers/usuarios");
exports.singUpValidation = (0, middlewares_1.validation)((getSchema) => ({
...
const SigUp = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield usuarios_1.UsuarioProvader.create(req.body);
