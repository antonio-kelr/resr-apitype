...
const coberturaImagens_1 = __importDefault(require("./routes/coberturaImagens"));
const recados_1 = __importDefault(require("./routes/recados"));
...
server.use('/coberturas', coberturas_1.default);
server.use('/recados', recados_1.default);
server.use('/coberturasImg', coberturaImagens_1.default);
