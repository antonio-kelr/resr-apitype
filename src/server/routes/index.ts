...
router.delete('/cidades/:id',TokemValidation, criateCidade.DeleteValidation, criateCidade.deleteById);
...
router.delete('/pessoas/:id',TokemValidation, criatePesoa.DeleteValidation, criatePesoa.deleteById);
...
router.delete('/agendas/:id',TokemValidation, criateAgenda.DeleteValidation, criateAgenda.deleteById);
